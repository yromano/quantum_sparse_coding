...
noise_vec = [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5]
...
noise_id = 1
b_noise_coef = noise_vec[noise_id]
exp_id = 12
...
eps = 1e-8
n_grid = 20
q_lam_L1 = np.logspace(np.log10(lambda_max * eps), np.log10(lambda_max), num=n_grid)[::-1]
np.append(q_lam_L1, 1e-10)
np.append(q_lam_L1, 1e-15)
