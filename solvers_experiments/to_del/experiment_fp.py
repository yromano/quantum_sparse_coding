...
# vector
noise_vec = [0.0, 0.05, 0.1, 0.15, 0.2]
...
out_dir = base_code_path
if type_x0 == "fixed_point":
    out_dir += "/solvers_experiments/results_fp"
else:
    out_dir += "/solvers_experiments/results"
...
methods_to_run = ["lasso_L1", "omp_L0"]
