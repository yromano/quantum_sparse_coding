...
def get_stats(s_L, r_L, r_L_test, xhat=None):
    ...
    if xhat is not None:
        print(xhat[ind_best_solution_x])
...
run_exhaustive_qubo_L0 = True
run_lasso_L1 = True
run_exhaustive_qubo_L1 = True
run_omp_L0 = False
    ...
    for exp_id in range(num_exps):
        ...
        [A, b, x0, A_test, b_test] = \
            RLS.generate_random_linear_system(N=N, M=M, K=K,
                                              ...
                                              b_noise_coef=b_noise_coef, seed=1)
        ...
        if run_exhaustive_L0 == True:
            ...
            rec_err_L0, cardinality_err_L0, rmse_L0, \
                cv_rec_err_L0, cv_cardinality_err_L0, cv_rmse_L0 = \
                    get_stats(s_L0, r_L0, r_L0_test, x_L0)
        ...
        if run_exhaustive_qubo_L0 == True:
            ...
            x_qubo_L0, r_qubo_L0, r_qubo_test_L0, k_qubo_L0, s_qubo_L0 = \
            ...
            rec_err_qubo_L0, cardinality_err_qubo_L0, rmse_qubo_L0, \
                cv_rec_err_qubo_L0, cv_cardinality_err_qubo_L0, cv_rmse_qubo_L0 = \
                    get_stats(s_qubo_L0, r_qubo_L0, r_qubo_test_L0, x_qubo_L0)
            ...
            results = results.append({'Experiment':exp_id,
                                      ...
                                      'Noise STD': b_noise_coef,
                                      'Method':'QUBO L0',
                                      'Infeasible X-Recovery L2 Err':rec_err_qubo_L0,
                                      'Infeasible X-Recovery L0 Err':cardinality_err_qubo_L0,
                                      'Infeasible System RMSE':rmse_qubo_L0,
                                      'CV X-Recovery L2 Err':cv_rec_err_qubo_L0,
                                      'CV X-Recovery L0 Err':cv_cardinality_err_qubo_L0,
                                      'CV System RMSE':cv_rmse_qubo_L0,
                                      'Type A':type_A,
                                      'Normalize A':lasso_normalize,
                                      'L0 Thresh':L0_th,
                                      'N':N,
        ...
        if run_lasso_L1 == True:
            ...
            rec_err_L1, cardinality_err_L1, rmse_L1, \
                cv_rec_err_L1, cv_cardinality_err_L1, cv_rmse_L1 = \
                    get_stats(s_L1, r_L1, r_L1_test, x_L1)
        ...
        if run_exhaustive_qubo_L1:
            ...
            rec_err_qubo, cardinality_err_qubo, rmse_qubo, \
                cv_rec_err_qubo, cv_cardinality_err_qubo, cv_rmse_qubo = \
                    get_stats(s_qubo, r_qubo, r_qubo_test, x_qubo)
        ...
        if run_omp_L0 == True:
            ...
            rec_err_omp, cardinality_err_omp, rmse_omp, \
                cv_rec_err_omp, cv_cardinality_err_omp, cv_rmse_omp = \
                    get_stats(s_omp, r_omp, r_omp_test, x_omp)
